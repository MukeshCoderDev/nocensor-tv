...
export interface LibertyDAOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface LibertyDAO extends BaseContract {
  connect(runner?: ContractRunner | null): LibertyDAO;
  waitForDeployment(): Promise<this>;

  interface: LibertyDAOInterface;
