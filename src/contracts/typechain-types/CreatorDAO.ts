...
export interface CreatorDAOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface CreatorDAO extends BaseContract {
  connect(runner?: ContractRunner | null): CreatorDAO;
  waitForDeployment(): Promise<this>;

  interface: CreatorDAOInterface;
