...
export interface ContentDAOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export namespace ContentFlaggedEvent {
  ...
  export type OutputTuple = [cid: string, flagger: string, reason: string];
...
export interface ContentDAO extends BaseContract {
  connect(runner?: ContractRunner | null): ContentDAO;
  ...
  creatorRegistry: TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
  ...
  flagContent: TypedContractMethod<
    [cid: BytesLike, reason: string],
    [void],
    "nonpayable"
  >;

  flaggedContent: TypedContractMethod<[arg0: BytesLike], [boolean], "view">;
  ...
  filters: {
    "ContentFlagged(bytes32,address,string)": TypedContractEvent<
      ContentFlaggedEvent.InputTuple,
      ContentFlaggedEvent.OutputTuple,
      ContentFlaggedEvent.OutputObject
    >;
