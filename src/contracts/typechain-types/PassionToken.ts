...
export interface PassionTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface PassionToken extends BaseContract {
  connect(runner?: ContractRunner | null): PassionToken;
  waitForDeployment(): Promise<this>;

  interface: PassionTokenInterface;
